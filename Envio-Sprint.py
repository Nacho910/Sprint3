...
def envios():
    ...
    cantidad_envio = input("Ingrese la cantidad a enviar que no exceda el stock: ")
...
print("Gracias por estar en Sistema de Envios PACLIGRI Company....") 