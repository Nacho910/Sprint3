...
def menu_principal():                                               # Funcion menu principal
    ...
    while continuar == "s":
        ...
        continuar = input(" Continua en Menu Principal s/n : ")

print("--- !!  Bienvenidos a nuestro sistema Mantencion Clientes de PACLIGRI Company.....!!")
menu_principal()
print("Gracias por estar en sistema Mantencion Clientes de PACLIGRI Company....") 